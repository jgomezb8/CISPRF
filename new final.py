...
def quest():
    while True:
        ...
        return guess
def chann():
        chancesi = int(input(f"Enter number of chances (1-100), default is 15: ")
        if chancesi == "":
            chances = 15
        if chancesi !=int:
            print('Must be a number this value')
            chann()
        else:
            try:
...
def main():
        ...
        while guesses_made < chances:
            ...
            print(f"Sorry",namep," you've run out of chances. The number was {n}.")
